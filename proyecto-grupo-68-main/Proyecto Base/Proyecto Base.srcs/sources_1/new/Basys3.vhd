...
signal d_btn_ex         : std_logic_vector(15 downto 0);
...
signal mili : std_logic_vector(15 downto 0);
signal micro : std_logic_vector(15 downto 0);
...
-- MUX in 
d_btn_ex <= "00000000000" & d_btn;
inst_mux_in : mux8 port map(
      mux_in_0    => seconds,
      mux_in_1    => mili,
      mux_in_2    => micro,
      mux_in_3    => sw(15 downto 0),
      mux_in_4    => d_btn_ex,
      mux_in_5    => ram_dataout,
      ram_address => ram_address,
      mux_in_out  => mux_in_out
      );

--instancia demux out
inst_demux_out : demux port map (
      demux_in    => write_ram,
      ram_address => ram_address,
...
inst_reg_dis : REG port map (
      ...
      down     => '0',
      datain   => ram_datain,
      dataout  => dis(15 downto 0)
      );
    
-- instancia registro led 
inst_reg_led : REG port map (
      ...
      down     => '0',
      datain   => ram_datain,
      dataout  => led(15 downto 0)
      ); 
lcd <= ram_dataout(9 downto 0) & demux_out_2;
